...
const saKeyPath = "/etc/secrets/mogibaai-storage-key.json"; // Render secret path
const projectId = process.env.GOOGLE_PROJECT_ID;

const MODEL_ID = "imagen-4.0-ultra-generate-preview-06-06"; // ULTRA
// Fast ki: const MODEL_ID = "imagen-4.0-fast-generate-preview-06-06";

async function generateUltraImage({ prompt, size = "1024x1024", userId = "public" }) {
  ...
  if (!aspectRatioMap[size]) throw new Error("Selected size not supported for Imagen 4 Ultra");
...
module.exports = generateUltraImage;
